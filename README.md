...
4) The tool will export all converted private keys to a new text file within the same folder. Check "list-WIF.txt" for WIF keys and "WIF2HexList.txt" for HEX keys.
